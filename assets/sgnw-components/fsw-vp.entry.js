...
*/
var fsw = fsw$1.exports;

var hasRequiredFsw;

function requireFsw () {
	if (hasRequiredFsw) return fsw$1.exports;
	hasRequiredFsw = 1;
	(function (module, exports) {
		(function (global, factory) {
		  factory(exports) ;
		})(fsw, (function (exports) {
		  /**
...
var fswExports = requireFsw();

const fswVpCss = () => `:host{writing-mode:vertical-lr;height:100%}:host span.outside{font-size:0%;line-height:0%;vertical-align:top}:host span.middle{vertical-align:bottom}fsw-sign,fsw-symbol{writing-mode:horizontal-tb;display:inline-block;vertical-align:middle;box-sizing:content-box}.text{writing-mode:horizontal-tb;display:inline-block;font-size:14px;line-height:1.2;padding:4px 6px}`;
...
const FswVp = class {
    ...
    fswSymbolKey(value) {
        const match = value.match(/S[0-9a-f]{5}/i);
    ...
    render() {
        ...
        let parts = [];
        try {
            parts = fswExports.parse.text(value);
        }
        catch {
        ...
        const items = parts.map(part => {
            try {
                return { ...fswExports.info(part), text: part };
            }
            catch {
        ...
        return (h(Host, { vp: value }, h("span", { class: "outside" }, h("span", { class: "middle" }, h("span", { class: "inside" }, items.map(item => {
            ...
            if (segment === 'sign' || segment === 'symbol') {
                ...
                if (segment === 'sign') {
                    return (h("fsw-sign", { sign: item.text, styling: this.styling, baseUrl: this.baseUrl, style: style }));
                }
                return (h("fsw-symbol", { symbol: this.fswSymbolKey(item.text), styling: this.styling, baseUrl: this.baseUrl, style: style }));
            }
