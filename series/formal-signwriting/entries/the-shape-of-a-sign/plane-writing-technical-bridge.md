...
General readers can skip this bridge without losing the main Sutton SignWriting Foundations argument. It is for readers who want the technical bridge behind the public essay and the Formal SignWriting signbox model.

It is not a detached specification.
...
## X. Why this bridge belongs with this entry
...
This bridge belongs beside it because it shows why that public claim has practical force.
