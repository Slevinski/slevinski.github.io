...
- can Sutton SignWriting become meaningful infrastructure?

It already is meaningful infrastructure.

The better question is:

- what kind of host structure would let existing infrastructure become stable, research-ready, fundable, and responsibly shared?

That host could be a university lab, a research institute, a library or archive unit, a nonprofit organization, a consortium, or a hybrid partnership.

The exact form can vary.

The required functions are more stable.

## What a host would inherit

A host would not be starting from zero.

The existing asset base includes:

- public domains and websites
- software tools and code libraries
- formal encoding systems and fonts
- dictionaries, datasets, and written materials
...
## Minimum host functions

A durable host would need to provide or coordinate several basic functions.
...
| Grant development | Turns existing assets and research questions into fundable proposals |
| Partner coordination | Gives international users and institutions a stable contact path |
| Community review | Keeps the work accountable to signed-language users, educators, and local contexts |
| Succession planning | Reduces dependence on one maintainer or one informal relationship |

These functions do not all need to be housed in one person.

They do need to be visible.

## What a host would not need to do first

A host would not need to:

- prove from scratch that SignWriting exists
- invent a new writing system
...
The first-step problem is continuity.

The second-step problem is turning continuity into a stronger base for research, education, data, and international collaboration.
...
| --- | --- |
| Public access | Reliable domains, hosting, monitoring, and user-facing continuity |
...
It should be able to make the layers explicit and improve them over time.

## Why a PI or academic lead still matters

Even in a broader institutional or consortium model, a PI or academic lead can be important.

That role can:

- align the work with research questions
- shape grant proposals
- support ethics and governance discussions
- connect the infrastructure to students, collaborators, and publications
- help distinguish scholarly claims from operational needs

But the PI role should not be confused with the whole infrastructure.

The infrastructure also needs technical stewardship, data stewardship, international coordination, and continuity planning.

## Why generic public wording matters

Before a host is formally secured, public materials should stay institution-neutral.
...
> a particular institution has already accepted that role.

That distinction is part of responsible stewardship.
