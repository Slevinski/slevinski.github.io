...
| --- | --- |
| University or lab | Research collaboration, grant development, ethics review, students |
| School or program | Teaching use cases, materials feedback, learner and teacher perspective |
| National institution | Public language resources, legitimacy, data workflows |
| Community organization | Local priorities, outreach, reader and user perspectives |
| Individual expert | Translation, technical support, advisory input |
| Country ambassador / local liaison | Relationship-building, documentation, follow-up coordination |

## What Partner Participation Can Provide

International participation can strengthen the program in several ways:

- it documents real-world educational and research reliance
- it shows that the need is not limited to one country or one project
- it helps future proposals describe actual communities and institutional settings
...
The most useful next actions are concrete:

- gather short statements of use from partners and educators
