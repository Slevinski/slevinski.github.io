...
**SignWriting Platform V3** (in progress) will provide:

* structured user registration (students, teachers, researchers)
* anonymized demographic data for research
* support for institutional and educational use
* a foundation for AI and translation pipelines
