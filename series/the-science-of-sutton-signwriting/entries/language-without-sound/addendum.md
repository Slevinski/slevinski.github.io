...
- https://m.signwriting.org/library-research.html
- https://m.signwriting.org/library-research-publications.html
...
- Abushaira, M. M. (2007). *The effect of SignWriting on the achievement and acquisition of vocabulary by deaf students at Al-Amal School for the Deaf in the City of Amman-Jordan* [Doctoral dissertation, King Abdulaziz University]. https://www.signwriting.org/archive/docs5/sw0489-AbuShairaDissertation2007English.pdf
...
- Bianchini, C. S., Borgia, F., & De Marsico, M. (2012, July). SWift: A SignWriting editor to bridge between Deaf world and e-learning. In *2012 IEEE 12th International Conference on Advanced Learning Technologies* (pp. 526-530). IEEE. https://doi.org/10.1109/ICALT.2012.235
- Borgia, F. (2015). *Computerization of a graphic form of sign languages: Application to the SignWriting writing system* [Doctoral dissertation, Université Toulouse 3 Paul Sabatier]. https://theses.fr/2015TOU30030
- Bózoli, D. M. F. (2021). *Educação bilíngue de surdos: o uso da escrita de sinais SignWriting na aprendizagem do português como segunda língua* [Doctoral dissertation, Universidade Federal de Santa Catarina]. https://repositorio.ufsc.br/handle/123456789/227006
- Costa, A. C. da R., & Dimuro, G. P. (2002). SignWriting-based sign language processing. In I. Wachsmuth & T. Sowa (Eds.), *Gesture and sign language in human-computer interaction* (Lecture Notes in Computer Science, Vol. 2298, pp. 202-205). Springer. https://doi.org/10.1007/3-540-47873-6_22
- Everson, M., Slevinski, S., & Sutton, V. (2012). *Proposal for encoding Sutton SignWriting in the UCS* (Unicode proposal N4342). Unicode Consortium. https://www.unicode.org/L2/L2012/12321-n4342-signwriting.pdf
...
- Hoffmann-Dilloway, E. (2011). Writing the smile: Language ideologies in, and through, sign language scripts. *Language & Communication, 31*(4), 345-355. https://doi.org/10.1016/j.langcom.2011.05.008
- Hoffmann-Dilloway, E. (2013). (Don't) write my lips: Interpretations of the relationship between German Sign Language and German across scales of SignWriting practice. *Signs and Society, 1*(2), 243-274. https://doi.org/10.1086/672321
- Hoffmann-Dilloway, E. (2018). Feeling your own (or someone else's) face: Writing signs from the expressive viewpoint. *Language & Communication, 61*, 88-101. https://doi.org/10.1016/j.langcom.2016.12.011
- McCarty, A. L. (2004). Notation systems for reading and writing sign language. *The Analysis of Verbal Behavior, 20*, 129-134. https://doi.org/10.1007/BF03392999
- Rosenberg, A. (1999). *Writing signed languages: In support of adopting an ASL writing system* [Master's thesis, University of Kansas]. https://www.signwriting.org/forums/research/rese010.html
- van der Hulst, H., & Channon, R. (2010). Notation systems. In D. Brentari (Ed.), *Sign languages* (pp. 331-355). Cambridge University Press. https://www.cambridge.org/core/books/sign-languages/notation-systems/BC84E83E70C5898394D686D1DF980ED1
...
- Bulla, L., et al. (2025). *Leveraging large language models for accurate sign language production*. arXiv. https://arxiv.org/abs/2508.18183
- Freitas, F. de A., Peres, S. M., Albuquerque, O. de P., & Fantinato, M. (2023). Leveraging sign language processing with Formal SignWriting and deep learning architectures. In *Intelligent Systems* (Lecture Notes in Computer Science, Vol. 14197, pp. 299-314). Springer. https://doi.org/10.1007/978-3-031-45392-2_20
- Iatskiu, C. E. A., García, L. S., & Antunes, D. R. (2017). Automatic SignWriting generation of Libras signs from CORE-SL. In *Proceedings of the XVI Brazilian Symposium on Human Factors in Computing Systems* (Article 55). ACM. https://doi.org/10.1145/3160504.3160581
- Jiang, Z., Moryossef, A., Muller, M., & Ebling, S. (2023). Machine translation between spoken languages and signed languages represented in SignWriting. In *Findings of the Association for Computational Linguistics: EACL 2023* (pp. 1706-1724). Association for Computational Linguistics. https://doi.org/10.18653/v1/2023.findings-eacl.127
- Lobo-Neto, V. C., & Pedrini, H. (2024). LSWH100: A handshape dataset for Brazilian sign language (Libras) using SignWriting. *Data in Brief, 56*, 110780. https://doi.org/10.1016/j.dib.2024.110780
- Matsumoto, T., Kato, M., & Ikeda, T. (2009). JSPad: A sign language writing tool using SignWriting. In *Proceedings of the 3rd International Universal Communication Symposium* (pp. 363-367). ACM. https://doi.org/10.1145/1667780.1667855
- Moryossef, A., et al. (2024). *Effective sign language evaluation via SignWriting*. arXiv. https://arxiv.org/abs/2410.13668
...
- Abushaira, M. M. (2007). *The effect of SignWriting on the achievement and acquisition of vocabulary by deaf students at Al-Amal School for the Deaf in the City of Amman-Jordan* [Doctoral dissertation, King Abdulaziz University]. https://www.signwriting.org/archive/docs5/sw0489-AbuShairaDissertation2007English.pdf
- Bouzid, Y., Khenissi, M. A., Essalmi, F., & Jemni, M. (2016). Using educational games for sign language learning: A SignWriting learning game case study. *Educational Technology & Society, 19*(1), 129-141. https://www.jstor.org/stable/jeductechsoci.19.1.129
- Bózoli, D. M. F. (2021). *Educação bilíngue de surdos: o uso da escrita de sinais SignWriting na aprendizagem do português como segunda língua* [Doctoral dissertation, Universidade Federal de Santa Catarina]. https://repositorio.ufsc.br/handle/123456789/227006
- Flood, C. M. (2002). *How do Deaf and hard-of-hearing students experience learning to write using SignWriting, a way to read and write signs?* [Doctoral dissertation, University of New Mexico]. https://www.signwriting.org/archive/docs1/sw0068-Flood-Dissertation-3.pdf
- Galea, M. A. (2014). *SignWriting (SW) of Maltese Sign Language (LSM) and its development into an orthography: Linguistic considerations* [Doctoral dissertation, University of Malta]. https://www.signwriting.org/archive/docs11/sw1003_SignWriting_in_Maltese_Sign_Langauge_Dissertation_Maria_Galea_Oct03_2014.pdf
- Gangel-Vasquez, J. (1998). *Literacy in Nicaraguan Sign Language: Assessing written sign recognition skills at the Escuelita de Bluefields* [Master's thesis, California State University, Dominguez Hills]. https://www.signwriting.org/forums/research/rese003.html
...
- Corina, D. P. (1992). The linguistic basis of left hemisphere specialization. *Science, 255*(5049), 1258-1260. https://doi.org/10.1126/science.1546322
