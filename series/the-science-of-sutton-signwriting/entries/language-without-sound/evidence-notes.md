# Language Without Sound Evidence Notes

**Brain networks, pathway expansion, literacy, and the case for SignWriting infrastructure**

This evidence-notes document identifies what is firmly established, what follows from it, where the structural gap lies for signed languages, what SignWriting already demonstrates, and where the evidence remains promising but incomplete. It also gathers the core references behind the argument in one place.
...
- Grushkin, D. A. (2017). [Writing signed languages: What for? What form?](https://doi.org/10.1353/aad.2017.0001) *American Annals of the Deaf, 161*(5), 509-527.
