...
- [x] Define the immediate path: Monday PI conversation, lab home at 0 percent, advocate-supported salary, grant writing, infrastructure growth
- [x] Define the parallel lanes: DMS work, salary support, grant-funded SignWriting infrastructure, gifts and donations
- [x] Write a short master narrative shared across the series
- [x] Make sure each deck uses the same timeline and support model
...
## Shared Master Narrative

- [x] The first move is a lab home under a PI.
- [x] That home creates institutional continuity and a credible base.
- [x] Steve creates immediate value through DMS planning, workflow support, code, and repository delivery.
...
Main ask:
- provide a lab home now, even at 0 percent salary support

Secondary outcomes:
- create a base for grants
- create a base for DMS and repository collaboration
- create a base for gifts and donations through the PI

### 2. Steve Slevinski Value
