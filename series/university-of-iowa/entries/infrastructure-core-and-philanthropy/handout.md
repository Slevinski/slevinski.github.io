...
Sutton SignWriting enables signed language to exist in written, structured, and reusable form.

That creates impact across:
...
A philanthropic investment can establish:

### The Sutton SignWriting Infrastructure Core
...
This work sits in a gap:

* too infrastructure-oriented for traditional humanities funding alone
...
The University of Iowa is uniquely positioned because this work connects:

* accessibility and disability inclusion
* literacy and Deaf education
* linguistics and multimodal communication
* research data infrastructure

This allows the core to live at the intersection of multiple strengths.

## The Structure

This effort follows a layered model:
