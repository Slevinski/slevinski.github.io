...
| `Plane-Based Writing and Script Typology` | Working Paper | `entries/plane-based-writing-and-script-typology/essay.md` | `plane-based-writing-working-paper-v1.0.0.pdf` | Series DOI | https://doi.org/10.5281/zenodo.20070484 | Strong standalone writing-systems paper; evidence notes intended for the document DOI companion packet. |
| `Point, Line, and Plane Evidence Notes` | Evidence Notes | `entries/plane-based-writing-and-script-typology/point-line-plane-evidence-notes.md` | `plane-based-writing-evidence-notes-v1.0.0.pdf` | Series DOI | https://doi.org/10.5281/zenodo.20070484 | Companion to `Plane-Based Writing and Script Typology`; upload only in that document DOI packet or cite through the series DOI. |
...
| `Kinematography and the Limits of Writing-System Typology` | Working Paper | `entries/kinematography-and-the-limits-of-writing-system-typology/essay.md` | `kinematography-typology-working-paper-v1.0.0.pdf` | Series DOI | https://doi.org/10.5281/zenodo.20070484 | Strong standalone theory capstone. |
